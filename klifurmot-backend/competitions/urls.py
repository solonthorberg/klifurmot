...
urlpatterns = [
    ...
    path("public/", views.public_competitions, name="public_competitions"),
    ...
    path("<int:competition_id>/categories/", views.categories, name="categories"),
    path(
        "categories/<int:category_id>/", views.category_detail, name="category_detail"
    ),
    path(
        "<int:competition_id>/categories/<int:category_id>/rounds/",
        views.create_round,
        name="create_round",
    ),
